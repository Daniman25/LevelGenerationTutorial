...
public class LevelGeneration : MonoBehaviour
{
    ...
    private void Move()
    {
        ...
        else if (direction == 5)
        {
            ...
            {
                //When levelGeneration moves vertically, need to make sure the room we are currently in has bottom openings
                //and the room above will have a top opening  We will use roomDetection and the RoomDestruction 
                    ...
                    roomDetection.GetComponent<RoomType>().type != 3)
                {
                    ...
                    int randTopOpeningRoom = 3; //To Guarentee we have a top and bottom opening
